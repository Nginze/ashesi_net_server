...
def update_user(user_id):
    ...
    user_exists.major = user.get('major') if user.get(
        'major') else user_exists.major
    user_exists.year_group = user.get('year_group') if user.get(
        'year_group') else user_exists.year_group
    user_exists.favorite_food = user.get('favorite_food') if user.get(
        'favorite_food') else user_exists.favorite_food
    user_exists.favorite_movie = user.get('favorite_movie') if user.get(
        'favorite_movie') else user_exists.favorite_movie
    user_exists.residency = user.get('residency') if user.get(
        'residency') else user_exists.residency
...
def setup_profile(user_id):
    ...
    user_exists.student_id = user.get('student_id') if user.get(
        'student_id') else user_exists.student_id
    user_exists.date_of_birth = user.get('date_of_birth') if user.get(
        'date_of_birth') else user_exists.date_of_birth
    user_exists.bio = user.get('bio') if user.get('bio') else user_exists.bio
    user_exists.major = user.get('major') if user.get(
        'major') else user_exists.major
    user_exists.year_group = user.get('year_group') if user.get(
